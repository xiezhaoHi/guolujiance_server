...
static QString        QSTR_DB_CON_STR                        = QStringLiteral("DRIVER={SQL SERVER};SERVER=125.71.238.129, 1334\\SQL2005;DATABASE=H2SMonitor");
static QString        QSTR_DB_USER                           = QStringLiteral("sa");
static QString        QSTR_DB_PASSWORD                       = QStringLiteral("123456");
static QString        QSTR_DB_HOSTNAME                       = QStringLiteral("125.71.238.129");
static int            N_DB_PORT                              = 1334;
